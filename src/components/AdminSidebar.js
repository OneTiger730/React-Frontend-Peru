...
export const AdminSidebar = ({ collapseSidebar }) => {
  ...
  const [showAdminSignalProviderScroll, setShowAdminSignalProviderScroll] = useState(false);
  const [showTradingSymbolsScroll, setShowTradingSymbolsScroll] = useState(false);
                        ...
                        <ul className="mt-5">
                          ...
                          <li className="sub-menu">
                            <Link
                              to="#0"
                              onClick={() =>
                                setShowAdministratorScroll(!showAdministratorScroll)
                              }
                              className={`${
                                location.pathname.includes('/admin/administrator')
                                  ? 'active'
                                  : ''
                              } `}
                            >
                          ...
                          <li className="sub-menu">
                            <Link
                              to="#0"
                              className={`${
                                location.pathname.includes('/admin/signal-provider')
                                  ? 'active'
                                  : ''
                              } `}
                              onClick={() =>
                          ...
                          <li className="sub-menu">
                            <Link
                              to="#0"
                              className={`${
                                location.pathname.includes('/admin/trade-signals/')
                                  ? 'active'
                                  : ''
                              } `}
                              onClick={() => 
                          ...
                          <li className="sub-menu">
                            <Link
                              to="#0"
                              className={`${
                                location.pathname.includes('/admin/trade-executed/')
                                  ? 'active'
                                  : ''
                              } `}
                              onClick={() => 
                          ...
                          <li className="sub-menu">
                            <Link
                              to="#0"
                              onClick={() =>
                                setShowTradingSymbolsScroll(!showTradingSymbolsScroll)
                              }
                              className={`${
                                location.pathname.includes('/admin/trading-symbols')
                                  ? 'active'
                                  : ''
                              } `}
                            >
                            ...
                            >
                              ...
                              <li>
                                <Link
                                  ...
                                  className={`${
                                    location.pathname === '/admin/trading-symbols/view-trade-symbols'
                                      ? 'active'
                                      : ''
                                  } `}
                                >
